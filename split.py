...
bvh_folder=[os.path.join(rootdir,"train","complete"),os.path.join(rootdir,"train","incomplete"),os.path.join(rootdir,"val","complete"),os.path.join(rootdir,"val","incomplete")]
total_files=[]
